...
__mram_noinit char mram_domains[DOMAIN_MEM_SIZE];  // store the chars of domain
...
void run_inference(Example *example) {
    ...
    // Free memory when inference is complete
    mem_reset();  
}
...
void dpu_task() {
    ...
    // Read the Example structure from MRAM
